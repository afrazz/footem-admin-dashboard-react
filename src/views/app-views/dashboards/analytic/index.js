...
const rederRegionTopEntrance = (data) => {
  console.log(data, 'helllooooo')
  return (
...
//       <div className="d-flex align-items-center">
//         {/* <Avatar size={20} src="/img/flags/us.png" /> */}
//         <h2 className="mb-0 font-weight-bold">689</h2>
//       </div>
//       <span className="text-muted">currentMonthUsers</span>
//     </Card>
//   </Col>
...
//         <h2 className="mb-0 font-weight-bold">689</h2>
//       </div>
//       <span className="text-muted">lastMonthUsers</span>
//     </Card>
//   </Col>
//   <Col xs={8} sm={8} md={8} lg={8} xxl={8}>
//     <Card>
...
//         <h2 className="mb-0 font-weight-bold">689</h2>
//       </div>
//       <span className="text-muted">loggedInUsers</span>
//     </Card>
//   </Col>
//   <Col xs={8} sm={8} md={8} lg={8} xxl={8}>
//     <Card>
...
//         <h2 className="mb-0 font-weight-bold">689</h2>
//       </div>
//       <span className="text-muted">loggedOutUsers</span>
//     </Card>
//   </Col>
// </Row>
// )
    ...
    <>
      <Row gutter={16}>
        <Col xs={24} sm={24} md={24} lg={12} xxl={12}>
          <RegiondataWidget
            title="Users"
            data={usersAnalytics?.countries}
            content={rederRegionTopEntrance(
              _.omit(usersAnalytics, ['countries'])
            )}
