  ...
  return (
    <div>
      ...
      <div className="mt-4">
        <ComponentIntro
          name="Location"
          desc="src/components/shared-components/RegiondataWidget.js"
        />
        <ComponentIntro
          name="Description"
          desc="Widget for display regions & data"
        />
        <div className="mt-4">
          <Card title="Example">
            <Demo />
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  array{'<'}
                  {'{'}name: string, data: string, color: string{'>'}
                  {'}'}
                </td>
                <td>[]</td>
              </tr>
              <tr>
                <td>mapSource</td>
                <td>
                  geography SVG, More geography SVG can be found in this{' '}
                  <a
                    href="https://github.com/deldersveld/topojson/tree/master/countries"
                    target="_blank"
