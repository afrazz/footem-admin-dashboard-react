...
const SideNavContent = (props) => {
  ...
  const { navigationData } = useSelector((state) => state.auth)

  console.log(navigationData, 'heyyyy')

  const menuItems = getSideNavMenuItem(navigationData)
...
const TopNavContent = () => {
  ...
  const menuItems = getTopNavMenuItem(navigationData)
