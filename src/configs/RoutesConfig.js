...
export const protectedRoutes = [
  ...
  //   component: React.lazy(() =>
  //     import('views/app-views/dashboards/category/category-list')
  //   ),
  // },

  // {
  //   key: 'dashboard.category.add-category',
  //   path: `${APP_PREFIX_PATH}/dashboards/category/add-category`,
  //   component: React.lazy(() =>
  //     import('views/app-views/dashboards/category/add-category')
  //   ),
  // },

  // {
  //   key: 'dashboard.category.edit-category',
  //   path: `${APP_PREFIX_PATH}/dashboards/category/edit-category/:id`,
  //   component: React.lazy(() =>
  //     import('views/app-views/dashboards/category/edit-category')
  //   ),
  // },

  // {
  //   key: 'dashboard.headline',
  //   path: `${APP_PREFIX_PATH}/dashboards/headline`,
  //   component: React.lazy(() =>
  //     import('views/app-views/dashboards/headline/headline-list')
  //   ),
  // },

  // {
  //   key: 'dashboard.headline.add-headline',
  //   path: `${APP_PREFIX_PATH}/dashboards/headline/add-headline`,
  //   component: React.lazy(() =>
  //     import('views/app-views/dashboards/headline/add-headline')
  //   ),
  // },

  // {
  //   key: 'dashboard.headline.edit-headline',
  //   path: `${APP_PREFIX_PATH}/dashboards/headline/edit-headline/:id`,
  //   component: React.lazy(() =>
  //     import('views/app-views/dashboards/headline/edit-headline')
  //   ),
  // },

  {
    ...
    component: React.lazy(() =>
      import('views/app-views/dashboards/user/user-list')
    ),
  },
  {
    key: 'dashboard.users.add-user',
    path: `${APP_PREFIX_PATH}/dashboards/users/add-user`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/user/add-user')
    ),
  },

  {
    key: 'dashboard.users.edit-user',
    path: `${APP_PREFIX_PATH}/dashboards/users/edit-user/:id`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/user/edit-user')
    ),
  },

  {
    key: 'dashboard.language',
    path: `${APP_PREFIX_PATH}/dashboards/language`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/language/language-list')
    ),
  },

  {
    key: 'dashboard.language.add-language',
    path: `${APP_PREFIX_PATH}/dashboards/language/add-language`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/language/add-language')
    ),
  },

  {
    key: 'dashboard.language.edit-language',
    path: `${APP_PREFIX_PATH}/dashboards/language/edit-language/:id`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/language/edit-language')
    ),
  },

  {
    key: 'dashboard.league',
    path: `${APP_PREFIX_PATH}/dashboards/league`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/league/league-list')
    ),
  },

  {
    key: 'dashboard.league.add-league',
    path: `${APP_PREFIX_PATH}/dashboards/league/add-league`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/league/add-league')
    ),
  },

  {
    key: 'dashboard.suggestedTeam',
    path: `${APP_PREFIX_PATH}/dashboards/suggestedTeam`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/suggestedTeam/suggestedTeam-list')
    ),
  },

  {
    key: 'dashboard.suggestedTeam.add-suggestedTeam',
    path: `${APP_PREFIX_PATH}/dashboards/suggestedTeam/add-suggestedTeam`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/suggestedTeam/add-suggestedTeam')
    ),
  },

  {
    ...
    component: React.lazy(() =>
      import('views/app-views/dashboards/news/news-list')
    ),
  },

  {
    key: 'dashboard.news.add-news',
    path: `${APP_PREFIX_PATH}/dashboards/news/add-news`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/news/add-news')
    ),
  },

  {
    key: 'dashboard.news.edit-news',
    path: `${APP_PREFIX_PATH}/dashboards/news/edit-news/:id`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/news/edit-news')
    ),
  },

  {
    key: 'dashboard.youtubeVideo',
    path: `${APP_PREFIX_PATH}/dashboards/youtubeVideo`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/youtubeVideo/youtubeVideo-list')
    ),
  },

  {
    key: 'dashboard.youtubeVideo.add-youtubeVideo',
    path: `${APP_PREFIX_PATH}/dashboards/youtubeVideo/add-youtubeVideo`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/youtubeVideo/add-youtubeVideo')
    ),
  },

  {
    key: 'dashboard.youtubeVideo.edit-youtubeVideo',
    path: `${APP_PREFIX_PATH}/dashboards/youtubeVideo/edit-youtubeVideo/:id`,
    component: React.lazy(() =>
      import('views/app-views/dashboards/youtubeVideo/edit-youtubeVideo')
    ),
  },
